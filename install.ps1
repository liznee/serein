...
#
# 用法（PowerShell）:
#   irm https://serein.run/install.ps1 | iex
#
# 或本地执行:
#   powershell -ExecutionPolicy Bypass -File install.ps1
#   powershell -ExecutionPolicy Bypass -File install.ps1 -InstallUrl https://raw.githubusercontent.com/OWNER/REPOSITORY/main
#
# 功能:
...
if (-not $baseUrl) {
  ...
  Write-Warn "请在发布前设置 SEREIN_INSTALL_URL，当前安装地址仍是占位符: $baseUrl"
}
